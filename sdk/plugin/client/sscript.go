...
func (c *CClient) RunCommand(batch *common.Batch, cmd string) ([]*common.CmdResult, error) {
...
func (c *CClient) RunScript(batch *common.Batch, script string, params []string) ([]*common.CmdResult, error) {
	serverInfo, err := c.Registry.Get("pilotgo-server")
	if err != nil {
		return nil, err
	}
...
func (c *CClient) RunCommandAsync(batch *common.Batch, cmd string, callback RunCommandCallback) error {
	serverInfo, err := c.Registry.Get("pilotgo-server")
	if err != nil {
		return err
	}
...
func (c *CClient) startCommandResultProcessor() {
	go func() {
		for {
...
func (c *CClient) registerCommandResultCallback(taskID string, taskLen int, callback RunCommandCallback) {
...
func (c *CClient) ProcessCommandResult(command_result *common.AsyncCmdResult) {
